...
public:
	 ...
	 * @param ClientMessageID 클라이언트에서 생성한 메시지 ID (Pending 메시지 매칭용)
	 */
	UFUNCTION(BlueprintCallable, Category = "Chat")
	void SendMessage(const FString& MessageContent, const FGuid& ClientMessageID);
	...
	void ServerSendMessage(APlayerState* SenderPlayerState, const FString& MessageContent, const FGuid& ClientMessageID);
