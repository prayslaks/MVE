...
&nbsp;	- Comfy UI 기반의 캐릭터 모델 생성 및 리깅

&nbsp;	- 스튜디오 사용자가 입력한 프롬프트 기반의 버츄얼 아이돌 페르소나로 콘서트 사용자와 온라인 채팅

&nbsp;     - 스튜디오 사용자가 입력한 히스토리 기반의 콘서트 사용자 채팅 필터링, 악성 유저 필터링 시스템

&nbsp;     - 웹캠 기반 동영상 인식 AI 서버에서 전달하는 버츄얼 아이돌의 움직임 데이터로 스켈레탈 메시 조작
